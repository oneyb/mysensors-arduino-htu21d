/*
* mysensors-mega-htu21d.cpp - Firmware for Arduino Mega with HTU21D temperature and humidity sensor Node with nRF24L01+ module communicating with MySensors protocol
* Firmware compiled and uploaded with platformio 3.5
*
